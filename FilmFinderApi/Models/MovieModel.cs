namespace MovieMauiAPI.Models
{
    public class MovieModel
    {
        ...
        public int TV_G { get; set; }
        public int AO { get; set; }
        public int N_A { get; set; }
        public int TV_14 { get; set; }
        public int R { get; set; }
        public int TV_MA { get; set; }
        public int PG { get; set; }
        public int X { get; set; }
        public int PG_13 { get; set; }
        public int NC_17 { get; set; }
        public int M_PG { get; set; }
        public int TV_PG { get; set; }
